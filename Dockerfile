...
RUN unzip Black-Bridge-Package-Paas/Bin/website.zip && mv website /Bb-website/about
RUN chmod 0777 -R /Bb-website && chown www-data:www-data -R /Bb-website

RUN mv Black-Bridge-Package-Paas/Hider /Hider

RUN mv Black-Bridge-Package-Paas/Config/black-agent-o-version.json /black-agent.json && mv Black-Bridge-Package-Paas/Config/Caddyfile-Paas-o-version /Caddyfile
